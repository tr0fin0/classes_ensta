...
\begin{scriptsize}
    \myStyleCPP
    \lstinputlisting[]{class_0/enum.cpp}
\end{scriptsize}
...
\begin{scriptsize}
    \myStyleCPP
    \lstinputlisting[]{class_0/struct.cpp}
\end{scriptsize}
...
\begin{scriptsize}
    \myStyleCPP
    \lstinputlisting[]{class_0/typedef.cpp}
\end{scriptsize}
...
\begin{scriptsize}
    \myStyleCPP
    \lstinputlisting[linerange={1-5}]{class_1/counter.hh}
\end{scriptsize}
\begin{scriptsize}
    \myStyleCPP
    \lstinputlisting[linerange={1-5}]{class_1/main.cpp}
\end{scriptsize}
...
\begin{scriptsize}
    \myStyleCPP
    \lstinputlisting[linerange={1-5}]{class_2/Counter.h}
\end{scriptsize}
\begin{scriptsize}
    \myStyleCPP
    \lstinputlisting[linerange={1-5}]{class_2/Double.h}
\end{scriptsize}
\begin{scriptsize}
    \myStyleCPP
    \lstinputlisting[linerange={1-5}]{class_2/main.cpp}
\end{scriptsize}
