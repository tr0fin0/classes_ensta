...
\begin{scriptsize}\mycode
    \lstinputlisting[language=C++, linerange={1-5}]{TD/28_09_2022/Number.hpp}
\end{scriptsize}
\begin{scriptsize}\mycode
    \lstinputlisting[language=C++, linerange={1-5}]{TD/28_09_2022/Array.hpp}
\end{scriptsize}
\begin{scriptsize}\mycode
    \lstinputlisting[language=C++, linerange={1-5}]{TD/28_09_2022/Vector.hpp}
\end{scriptsize}

\begin{scriptsize}\mycode
    \lstinputlisting[language=C++, linerange={1-5}]{TD/28_09_2022/main.cpp}
\end{scriptsize}
difference entre array and Vector

\newpage\subsection{Séance 05/10/2022}
\paragraph{Présentation}Dans ce \href{https://perso.ensta-paris.fr/~bmonsuez/Cours/doku.php?id=in204:seances:seance5}{TD} on avait besoin d'implementer ...
\begin{scriptsize}\mycode
    % \lstinputlisting[language=C++, linerange={1-5}]{TD/28_09_2022/Number.hpp}
\end{scriptsize}
\end{document}