...
\end{scriptsize}
main qui inicialise numeros treads qui va afchi des mensagens avec des variables locaux un plain text qui safhice separadement
variables partages et atendre les threads à la fin
\end{document}