...
\begin{scriptsize}
    \mycode\lstinputlisting[language=C++]{class_0/template.cpp}
\end{scriptsize}
...
\paragraph{Présentation}Dans ce TD on avait besoin d'implementer des \texttt{templates} pour étudier comme réduire et améliore le code avec la même implementation mais des types différents.
\begin{scriptsize}
    \mycode
    \lstinputlisting[language=C++, linerange={1-5}]{class_3/join.h}
\end{scriptsize}
\begin{scriptsize}
    \mycode
    \lstinputlisting[language=C++, linerange={1-5}]{class_3/main.cpp}
\end{scriptsize}
