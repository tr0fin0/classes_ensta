...
\begin{center}
    \begin{minipage}[b]{0.3\textwidth}
        \tableN{jki [1]}{
            ...
            1024 & 0.1016900 & 21118.0\\
            1025 & 0.1103160 & 19523.8\\
        }{
            2047 & 0.557667 & 30761.6\\
            2048 & 0.455107 & 37749.1\\
            2049 & 0.491632 & 34995.8\\
        }{
            - &  & \\
        }
    \end{minipage}
    \begin{minipage}[b]{0.3\textwidth}
        \tableN{jki [4]}{
            1023 & 0.1024900 & 20891.8\\
            1024 & 0.0908985 & 23625.1\\
            1025 & 0.1195870 & 18010.2\\
        }{
            2047 & 0.497154 & 34505.9\\
            2048 & 0.570854 & 30095.0\\
            2049 & 0.500602 & 34368.7\\
        }{
            - &  & \\
        }
    \end{minipage}
    \begin{minipage}[b]{0.3\textwidth}
        \tableN{jki [8]}{
            ...
            1024 & 0.1197250 & 17936.8\\
            1025 & 0.1059470 & 20328.8\\
        }{
            2047 & 0.513362 & 33416.4\\
            2048 & 0.471373 & 36446.5\\
            2049 & 0.475105 & 36213.1\\
        }{
            - &  & \\
        }
    \end{minipage}
...
\begin{center}
    ...
    \begin{minipage}[b]{0.3\textwidth}
        \tableN{jki [16]}{
            ...
            1025 & 0.1216330 & 17707.3\\
        }{
            2047 & 0.513362 & 31244.3\\
            2048 & 0.439260 & 39110.9\\
            2049 & 0.483793 & 35561.8\\
        }{
            - &  & \\
        }
    \end{minipage}
    \begin{minipage}[b]{0.3\textwidth}
        \tableN{jki [20]}{
            ...
            1024 & 0.1108460 & 19373.5\\
            1025 & 0.1088740 & 19782.3\\
        }{
            2047 & 0.568054 & 30199.1\\
            2048 & 0.473769 & 36262.1\\
            2049 & 0.493240 & 34881.7\\
        }{
            - &  & \\
        }
    \end{minipage}
