...
lecture puis note de sythèse et de recommandations ou orientations stratégiques ou politiques

méthode de lecture des documents nécessaires à la rédaction d'une note de synthèse suivie d'orientations stratégiques ou politiques

il faudra repérer parmi les documents distribués, certains peuvent ne pas être utilisés hors sujet ou redondants:
les plus importants puis extraire les information utiles pour chaque document utilisé, 5 dates, 5 lieux, 5 faits, 5 personnes, 5 entreprises ouo territoires ou organisations pour renseigner le tableau type de classification contexte, enjeux, objectifs, mesures, moyens, évaluation

ces rubriques apparaissent toujours dans une note stratégique ou politique comportant souvent 2 parties avec 2 sous parties titrées (1.1 - 1.2 et 2.1 - 2.2)

elles permettent de répondre aux questions suivantes: pourquoi? (1.1 contexte, 1.2 enjeux) quoi? (1.2 objectifs) comment? (2.1 mesures moyens) avec quels résultats (2.2)


la maîtrise du temps est la clé du succés
titrer les parties et sous parties
13 mots en moyenne: theme et these quoi on parler et quoi on defende


dire le nom de l'entreprise
faire la conclusion d'abord et après faire le reste
donner des recommandations personneles pour completer, parfois il y a des informations dans le document fournir

s'il y a de tittres avec le meme texte il n'y a pas besoin de lire les deux, jute un

----
chapitre 2
les conditions de base de la LOE actuellement

macroéconomie / internacional
mondialisation et généralisation de l'économie de marchés

le capital, le connaisance et les produits

LM et NLM of innovation depuis les USA à la Chine
Modèle Lineaire
sans finalité défini
Modèle Non Lineaire
avec finalité défini
pour qu'il y ait un NLM il faut que pré-existe un LM de l'innovation
un nouvel ordre mondial s'est mis en place entre 200 et 2021
alors que USA, China, Korea, India dominent la dynamique mondiale de production de connaissances scientifiques nombre de publications scientifiques l'europe et la france en particulier cèdent du terrain

LM according to Bush
a nation which depends upon others for its new basic scientific knowledge will be slow in its industrial progress and weak in its competitive position in wolrd trade

modele lineaire, avec l'entree de investisant dans la recherche on gagnera la même chose après . entreprise investir pour R&D qui décrouvera des technologies pour décrouvrir des produits et faire de


inputs outputs
développement de méthodes d'achats électroniques complémentaires ou substitives: banque, presse, livres, musique, films

accélération des cycles de vie des produits et réduction de leurs durrées de vie: conception (temps divisé par 2 en 10 dans industrie automobile 1 dessin et production industrielle: de 6 ans à 36 mois obsolescence programmée, marketing, publicitée)

influence grandissante du rapport valeur/temps (valeur/poids): temps production, consommation

développement de la consommation multi-modale des produits informationnels avec complémentairé et/ou substituabilité


développement des publicités multi-modales, interactives et personnalisées

technologiesmeilleure diffusion / accessibilité des technologies de production: grande série plus accessibles (de 100000 u à 1000 u) MOCN (informaticiens généralistes plus répandus que mécaniciens spécialistes) impressions 3D

travail, capital, information, connaissances, combinaison productive
croissance exponentielle de l'offre d'information à coûts constans connaissances (publications) technologies (brevets) 2 5\% par an

développement général de la confiance et de l'incitation au détriment de l'autorié dans les modes de gouvernance et de management (adhocratie versus hiérarchie)

généralisation de la fluxibilité/précarieté du travail, les deux sont différents formes de voir le travail en ce moment
vulgarisation du travail c'est plus neutre


les stratégies de la LOE actuellementprinx inférieurs au coût marginal sur certains marchés informationnels grâce au développement des subventions croisées et des marchés bifaces (tirole): domination par les coûts jusqu'aux (marchés augmentés) de la mobilité , de l'énergie et du numérique
développement de l'innovation en réseau et de l'open innovation: différenciation, domination par les coûts, coopération
